...
\begin{tikzpicture}
    ...
    \tikzset{
        kite/.pic={
            ...
            \draw[dash pattern=on 12pt off 17pt,line width=5pt,white] (0:\w) arc (0:72:\w);
            \draw[dash pattern=on 5pt off 12pt,line width=5pt,white] (72:\p*\w)++(-36:{\w/(1+\p)}) arc (144:288:\w/\p);
        },
        dart/.pic={
            % \draw[very thick] (0,0)--(0:\w*\p) -- (36:\w) --(72:\w*\p)--cycle;
            \draw[very thin,fill=#1] (0,0)--(0:\w*\p) -- (36:\w) --(72:\w*\p)--cycle;
            \draw[dash pattern=on 12pt off 17pt,line width=5pt,white] (0:\w/\p) arc (0:72:\w/\p);
            \draw[dash pattern=on 5pt off 12pt,line width=5pt,white] (72:\p*\w)++(-72:{\w/\p}) arc (108:324:{\w/(\p+1)});
        }
    }
...
% For tiling Dart on A3
    ...
    %     }
    % };
    \draw ({2*\w*\p*cos(54)*\w*\p*cos(54)},{\w*\p*sin(54)}) pic[rotate=-126] {dart=black};    
% \draw (0,0) pic[rotate=54] {kite=black};
\end{tikzpicture}
% \end{rotate}
\end{document}